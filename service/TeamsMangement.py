...
class TeamsMangement:
    ...
    def get_teams(team_admin_uuid):
        ...
        for i,team in enumerate(TeamsMangement.teamStore.find({"team_admin_uuid":team_admin_uuid})):
            team_obj ={
                "_id":str(team["_id"]),
    ...
    def add_member(team_uuid, token_data, team_member):
        ...
        if team_admin is not None:
            ...
            reponse = {
                "message":f"Couldn't found Team ID: {team_uuid}"
            }
            return reponse
    ...
    def delete_team(team_uuid, token_data):
        ...
        if team_admin is not None:
            if uuid_key == team_admin: 
                response = {
                    "message":f"Team ID: {team_uuid} was deleted"
                }
                ...
                reponse = {
                    "message":"Only team administrator can be delete the team"
                }
                return reponse
        else:
            reponse = {
